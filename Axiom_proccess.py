...
class make_excel ():
    ...
    def newdata(self,ex_data):
        ...
        for i in range(len(ex_data)):
            ...
            if re.match(r'\*\d|\*+\d', ex_data[i]):
            ...
            elif re.match(r'Time:+\d|Time:\d',ex_data[i]):
                ...
                if ex_data [i] == "sKVP:" or ex_data [i] == "\dKVP:" or ex_data[i] == "KVP:" or ex_data[i] == '\wKVP:':
    ...
    def startpro(self,word_file, index):
        ...
        if o == 1:
         ...
         ###### make all list without words######
            ...
            self.moddap = [item.split(' ')[0] if item != "N/A" else "N/A" for item in self.dap]
